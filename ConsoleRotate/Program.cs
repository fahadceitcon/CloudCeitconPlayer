...
using static ConsoleRotate.Program.Display;

namespace ConsoleRotate
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine("1. DEGREES_CW_0");
            Console.WriteLine("2. DEGREES_CW_90");
            Console.WriteLine("3. DEGREES_CW_180");
            Console.WriteLine("4. DEGREES_CW_270");
            ...
            switch (userChoice)
            {
                ...
                case "2":
                    {
                        Display.Rotate(1, Orientations.DEGREES_CW_90);
                    }
                    break;
                case "3":
                    {
                        Display.Rotate(1, Orientations.DEGREES_CW_180);
                    }
                    break;
                case "4":
                    {
